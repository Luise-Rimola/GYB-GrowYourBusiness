...
> = {
  ...
  WF_MARKET: [{ stepKey: "market_snapshot", schemaKey: "market_snapshot", label: "Market snapshot" }],
  WF_RESEARCH: [
    { stepKey: "market_research", schemaKey: "market_research", label: "Market research" },
    { stepKey: "best_practices", schemaKey: "best_practices", label: "Best practices" },
    { stepKey: "failure_reasons", schemaKey: "failure_reasons", label: "Why businesses fail" },
  ],
