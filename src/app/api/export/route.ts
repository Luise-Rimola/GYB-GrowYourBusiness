...
const QUESTION_TEXT_BY_KEY: Record<string, string> = {
  ...
  fb1B3: "Ich vertraue KI-Outputs grundsaetzlich als Input fuer Business-Entscheidungen. (1-7)",
  fb1C1: "Unsere Entscheidungen sind aktuell gut strukturiert begruendet. (1-7)",
  fb1C2: "Unsere Entscheidungen sind fuer Dritte gut nachvollziehbar (Audit Trail). (1-7)",
